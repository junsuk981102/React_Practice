            ...
            <div style={{ backgroundColor: "#E5F2F2", minHeight: "100vh",  borderTop: "1px solid #00A29D" }}>
                <div style={{ paddingLeft: `${windowWidth > 1700 ? '500px' : '50px'}`, paddingRight: `${windowWidth > 1700 ? '500px' : '10px'}` }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center',fontSize: '20px', fontWeight: 'bold'}}>
                        <span> 티켓 판매 상태 : {saleStatus ? '판매 가능' : '판매 불가능'}</span>
                        <button
                            style={{
                                width: 'auto',
                                height: 'auto',
                    ...
                    <h3 style={{marginTop: "20px",marginBottom: "10px", display: 'flex', alignItems: 'center',fontSize: '20px', fontWeight: 'bold'}}>
                            티켓 리스트
                    </h3>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px' }}>
                        {governanceCardArray && governanceCardArray.map((v, i) => {
                            return (
                            <MyGovernanceCard
                                key={i}
                                GNT_Id={v.GNT_Id}
