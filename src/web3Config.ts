...
const mintPlantTokenAbi : AbiItem[] = [
	{
		"inputs": [],
		"stateMutability": "nonpayable",
		"type": "constructor"
...
const salePlantTokenAbi : AbiItem[] = [
	{
		"inputs": [
			{
				"internalType": "address",
...
const mintGovernanceTokenAbi : AbiItem[] = [
	{
		"inputs": [],
		"stateMutability": "nonpayable",
		"type": "constructor"
...
const saleGovernanceTokenAbi : AbiItem[] = [
	{
		"inputs": [
			{
				"internalType": "address",
...
export const mintPlantTokenContract = new web3.eth.Contract(
	mintPlantTokenAbi,
	mintPlantTokenAddress
);

export const salePlantTokenContract = new web3.eth.Contract(
	salePlantTokenAbi,
	salePlantTokenAddress
);

export const mintGovernanceTokenContract = new web3.eth.Contract(
	mintGovernanceTokenAbi,
	mintGovernanceTokenAddress
);

export const saleGovernanceTokenContract = new web3.eth.Contract(
	saleGovernanceTokenAbi,
